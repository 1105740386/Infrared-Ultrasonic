...
INO_SRCS += \
../header/IRremote/examples/IRrecvDump/IRrecvDump.ino 

INO_DEPS += \
./header/IRremote/examples/IRrecvDump/IRrecvDump.ino.d 


# Each subdirectory must supply rules for building sources it contributes
header/IRremote/examples/IRrecvDump/IRrecvDump.o: ../header/IRremote/examples/IRrecvDump/IRrecvDump.ino
	@echo 'Building file: $<'
