...
INO_SRCS += \
../header/IRremote/examples/IRrelay/IRrelay.ino 

INO_DEPS += \
./header/IRremote/examples/IRrelay/IRrelay.ino.d 


# Each subdirectory must supply rules for building sources it contributes
header/IRremote/examples/IRrelay/IRrelay.o: ../header/IRremote/examples/IRrelay/IRrelay.ino
	@echo 'Building file: $<'
