...
INO_SRCS += \
../header/IRremote/examples/IRrecord/IRrecord.ino 

INO_DEPS += \
./header/IRremote/examples/IRrecord/IRrecord.ino.d 


# Each subdirectory must supply rules for building sources it contributes
header/IRremote/examples/IRrecord/IRrecord.o: ../header/IRremote/examples/IRrecord/IRrecord.ino
	@echo 'Building file: $<'
