...
INO_SRCS += \
../header/IRremote/examples/IRtest2/IRtest2.ino 

INO_DEPS += \
./header/IRremote/examples/IRtest2/IRtest2.ino.d 


# Each subdirectory must supply rules for building sources it contributes
header/IRremote/examples/IRtest2/IRtest2.o: ../header/IRremote/examples/IRtest2/IRtest2.ino
	@echo 'Building file: $<'
